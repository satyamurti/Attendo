...
public class TakeattendanceCR extends AppCompatActivity {
    ...
    customLoadingBar customLoadingBar = new customLoadingBar(TakeattendanceCR.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_take_attendance_cr);
        setTitle("Attendance");
        ...
        classselected =bundle1.getString("class_selected");
        subjectselected =bundle1.getString("subject_selected");
        date = bundle1.getString("date_selected");

        TextView classname = (TextView) findViewById(R.id.textViewCRD);
        classname.setText(classselected);


        DatabaseReference dbuser = ref.child("Student");

        dbuser.orderByChild("classes").equalTo(classselected).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void OnStart(ArrayList<String> userlist) {
        ...
        ListView chl = (ListView) findViewById(R.id.checkable_listCRD);
    ...
    public void showSelectedItemsCR(View view) {


        String selItems = "";
        ref = FirebaseDatabase.getInstance().getReference();

        dbAttendance = ref.child("attendance").child(date).child(classselected).child(subjectselected);
...
//    public void AddtoReportCR(View view) {
//
//
//
//
...
//        try {
//            workbook = Workbook.getWorkbook(new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Attendo_ATT_Exel/" + classselected+"_month_"+date.substring(3,5)+ ".xls"));
//            wb = createWorkbook(classselected+"_"+subjectselected+"_month_"+date.substring(3,5),workbook);
//            s = wb.getSheet(0);
//
//        }
//        catch (Exception e){
//            //Toast.makeText(this,e.toString(),Toast.LENGTH_LONG).show();
//            File wbfile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Attendo_ATT_Exel/" + classselected + ".xls");
//            wb = createWorkbook(classselected+"_"+subjectselected+"_month_"+date.substring(3,5));
